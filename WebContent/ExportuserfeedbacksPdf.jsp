...
<body>
	...
	Phrase sn = new Phrase("Customer Name", boldFont);
	Phrase available = new Phrase("Customer Email", boldFont);
	Phrase location = new Phrase("Subject", boldFont);
	Phrase wd = new Phrase("Message", boldFont);
	...
	while (rs.next()) {
		...
		p3.add(rs.getString("customername"));
		p4.add(rs.getString("email"));
		p5.add(rs.getString("subject"));
		p6.add(rs.getString("message"));
