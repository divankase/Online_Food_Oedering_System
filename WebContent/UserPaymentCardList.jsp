  ...
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        ...
        <li>Type Of Entertainment : <c:out value="${user.typeofentertainment}" /> </li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserEntertainmentBook'" >Book</button>
