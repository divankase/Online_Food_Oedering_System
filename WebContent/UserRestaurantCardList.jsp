...
<body>
	...
	<c:forEach var="user" items="${listrestaurants}">
...
<div class="flip-card-container" style="--hue: 350">
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        <li>Restaurant Name :<c:out value="${user.restaurantname}" /></li>
        <li>Restaurant Menu Details: <c:out value="${user.restaurantmenudetails}" /> </li>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserrestaurantBook'" >Book</button>
