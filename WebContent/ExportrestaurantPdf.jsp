0<%@page import="java.sql.ResultSet"%>
...
<body>
	...
	Phrase cat = new Phrase("Restaurant Name", boldFont);
	Phrase wd = new Phrase("Working Days", boldFont);
	Phrase phone = new Phrase("Restaurant Contact", boldFont);
	...
	while (rs.next()) {
		...
		p3.add(rs.getString("restaurantname"));
		p4.add(rs.getString("workingdays"));
		p5.add(rs.getString("phone"));
