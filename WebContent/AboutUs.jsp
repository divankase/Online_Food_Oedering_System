...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="home/index.html"><span>EAT</span> 24/7</a>
    			...
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex" style="color:black;">Welcome to EAT 24/7 , where passion for food meets the power of technology! 
		            	We are not just an online food ordering system; we are your gateway to a world of flavors, 
		            	convenience, and delightful experiences.</li>
		            	<li class="d-flex" style="color:black;">At EAT 24/7, we are food enthusiasts and tech innovators 
		            	rolled into one. We understand the joy that comes from savoring a perfect bite, and we are 
		            	dedicated to bringing that joy to your doorstep. With our user-friendly platform, we've 
		            	simplified the way you enjoy your favorite meals, making the entire process as easy as pie 
		            	(or whichever dish you love most!).</li>
