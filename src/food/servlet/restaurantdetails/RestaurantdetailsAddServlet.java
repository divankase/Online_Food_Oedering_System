...
@WebServlet("/insertretaurantdetails")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 10, // 10MB
maxRequestSize = 1024 * 1024 * 50)
public class RestaurantdetailsAddServlet extends HttpServlet {
...
//	       /images/rooms/img.pngsssss
	   ...
	   Restaurantdetails Restaurantdetails = new Restaurantdetails(restaurantname, phone, workingdays, location,imgname,imagePath);
		try {
			RestaurantdetailsDao.insertRestaurantdetails(Restaurantdetails);
